...
function CartShow({children}) {
  ...
  // 
  return (
    <button aria-expanded={isCartOpen} aria-label="Open Cart" onClick={()=>{isCartOpen.set(!isCartOpen.get())}} class="flex place-content-end ml-auto md:ml-0 mr-4 sm:mr-8 relative">
